...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.logIn(user).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeToken('access-token', data.token);
...
var VideoCenterComponent = (function () {
    ...
    VideoCenterComponent.prototype.loadPage = function (page, categoryId) {
        ...
        this._videoService
            ...
            console.log('totta lPage = ' + _this.totalPages);
        });
        // .subscribe(
        //   ({ docs, page, pages }) => {
        //   this.videos = docs ;
...
var VideoListComponent = (function () {
    function VideoListComponent() {
        this.selectVideosCategory = "Select category";
    ...
    VideoListComponent.prototype.toggleDropdown = function (title) {
...
var AuthService = (function () {
    ...
    AuthService.prototype.setTokenFromResponse = function (observable) {
        ...
        observable
            ...
            _this.storeToken('access-token', token);
        });
    };
    // Set token to localstorage
    AuthService.prototype.storeToken = function (tokenKey, token) {
